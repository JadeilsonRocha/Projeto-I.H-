...
event btn_envio_state(void) {
  ...
  Serial.println(hum);   
  Serial.print("Variável contador: ");
...
event gerenciador_state(void) {
  ...
  if (read_button()==true) {
    ...
    return evento_btn;
  } else if (now - tempoDaUltimaMensagem >= 10000) { 
